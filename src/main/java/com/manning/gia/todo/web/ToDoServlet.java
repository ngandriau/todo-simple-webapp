...
public class ToDoServlet extends HttpServlet {
    ...
    private String processRequest(String servletPath, HttpServletRequest request) {
        ...
        try {
            String propFileResourceName = "filename.properties";
            System.out.println("=== Try to load prop file (" + propFileResourceName + ") as resource:");
            Properties properties = new Properties();

            URL propFileResourceURL = Thread.currentThread().getContextClassLoader().getResource(propFileResourceName);
            if (propFileResourceURL == null) {
                System.out.println("===  !!!Prop file Not Found!!!");
            } else {
                System.out.println("===  Prop file url:" + propFileResourceURL.toString());
            }

        } catch (Exception ex) {
            System.err.println("=== Ex while looking for resource file in the web app:" + ex.getMessage());
